...
suite('Maybe', function() {
  ...
  test('has a "nullary" data constructor named Nothing', function() {
    eq(S.Nothing['@@type'], 'sanctuary/Maybe');
    eq(S.Nothing.isNothing, true);
    eq(S.Nothing.isJust, false);
  });

  test('has a unary data constructor named Just', function() {
  ...
  test('"fantasy-land/traverse" method', function() {
